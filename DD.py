...
def main(file):
    ...
    if(n>36):
        ...
        if(n%2==1):
            ...
            t=0
            b=p
    occ = MatriceBinome.occurrenceEleve(matriceB,n)
    nbreRepartiton=1
    ...
    while(compteur<nbreRepartiton):
        ...
        r=-1
        result=triCritique(matriceB, matriceT, newMatriceBinome, newMatriceTrinome, n, b, t, p, occ, result, r, nb)
    ...
    while(compteur!=0):
        ...
        if(critique!=-1):
            ...
            if(MatriceBinome.estCritique(occ, bin)):
                ...
                t=t-1
                trinome=[critique,bin,indiceTrinome,MatriceTrinome.trinomeApp(matriceT,critique,bin,indiceTrinome)]
                result[nb]=trinome
                matriceB=MatriceBinome.supprBinome(matriceB,critique,bin)
